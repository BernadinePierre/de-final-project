...
def make_fact_payment(payment: pd.DataFrame, date: pd.DataFrame):
...
def make_fact_purchase_order(purchases: pd.DataFrame, date: pd.DataFrame):
...
def make_fact_sales_order(sales: pd.DataFrame, date: pd.DataFrame):
